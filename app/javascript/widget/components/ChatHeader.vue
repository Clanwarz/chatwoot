    ...
    <div class="header-branding">
      <img v-if="avatarUrl" :src="avatarUrl" alt="avatar" />
       <span class="header-elements">
        ...
        <span class="reply-eta" v-if="isOnline">Typically replies in a few hours</span>
        ...
        <span class="social-links">
            ...
            <span class="twitter" title="follow us on Twitter">
                <a href="https://twitter.com/Clanwarz" target="_blank" rel="noopener noreferrer">
                    <i class="fab fa-twitter"></i>
                </a>
            </span>
            <span class="linkedin" title="follow us on LinkedIn">
                <a href="https://www.linkedin.com/company/clanwarz-inc/" target="_blank" rel="noopener noreferrer">
